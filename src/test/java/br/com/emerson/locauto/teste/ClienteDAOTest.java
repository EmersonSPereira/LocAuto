...
public class ClienteDAOTest {
	...
	public void testBuscaPorId() {
		//alterando a cor do cliente com id = 1 para posteriormente comparar no teste de busca
		c1.setId(1);
		c1.setNome("Java");
		dao.salvar(c1);
		
		//teste de busca
		c1 = (ClientePF) dao.buscaPorId(1);
	...
	public void testBuscaTodos() {
		 ...
		 * contidos no banco, o teste abaixo verifica se a lista esta vazia, como anteriormente
		 * foi inserido um cliente no banco o teste tem que dar falso.
		 */
